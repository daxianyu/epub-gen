...
(function() {
  ...
  EPub = class EPub {
    ...
    generateTempFile() {
      ...
      Q.all([Q.nfcall(ejs.renderFile, opfPath, self.options), self.options.includeToc ? Q.nfcall(ejs.renderFile, ncxTocPath, self.options) : void 0, self.options.includeToc ? Q.nfcall(ejs.renderFile, htmlTocPath, self.options) : void 0]).spread(function(data1, data2, data3) {
